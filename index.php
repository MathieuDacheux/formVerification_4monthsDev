    ...
    <main>
        ...
        <form action="" method="post">
            ...
            <div class="containerInput">
                <input class="input" type="text" name="lastname" id="lastname" placeholder="Nom" pattern="^([A-Za-z]+[,.]?[ ]?|[A-Za-z]+['-]?)+$" required>
                <input class="input" type="text" name="firstname" id="firstname" placeholder="Prénom" pattern="^([A-Za-z]+[,.]?[ ]?|[A-Za-z]+['-]?)+$" required>
            </div>

            <!-- Input date de naissance -->
            <input class="input" type="date" name="birthday" id="birthday" placeholder="03/02/02" required>
            ...
            <div class="containerSelection">
                ...
                <div class="containerCheckbox">
                    <input type="checkbox" name="cPlus" id="cPlus"><span>C++</span>
                </div>
                <div class="containerCheckbox">
                    <input type="checkbox" name="rust" id="rust"><span>Rust</span> 
                </div>
            </div>
